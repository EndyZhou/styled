...
export type MakeStyleCb<TProps> = (theme: MainTheme, props: TProps) => ComponentStyledProps;

export type StyleObjectParam<TProps> =
  | MakeStyleCb<TProps>
  | {
      [K in keyof TProps]?: TProps[K] extends ComponentStyledProps ? ComponentStyledProps | MakeStyleCb<TProps> : never;
    };
...
export type StyledLayoutExtraKey = 'overflow' | 'overflowX' | 'overflowY' | 'display' | 'verticalAlign' | 'textAlign';
...
export type SpaceProps = CreateSystemComponentProps<StyledSpaceKey, CustomSpacePropValue>;

export type LayoutProps = CreateSystemComponentProps<StyledLayoutKey, CustomLayoutPropValue> &
...
export type FontSize = '8' | '10' | '12' | '13' | '14' | '16' | '18' | '20' | '22' | '24' | '26' | '28';

export type FontFamily = 'Roboto';

export type FontProps = CreateSystemCssProps<
  Exclude<StyledTypographyKey, 'fontWeight' | 'fontFamily' | 'fontSize' | 'letterSpacing'>
> &
  Partial<{
...
export type PositionProps = CreateSystemComponentProps<StyledPositionKey, CustomSpacePropValue> &
  CreateSystemCssProps<StyledPositionExtraKey>;

export type BorderRadiusKey = 'none' | 'sm' | 'md' | 'lg' | 'xl' | 'pill' | 'full' | 'xxl' | number;

export type BorderProps = CreateSystemCssProps<StyledBorderExtraKey> &
  CreateSystemComponentProps<StyledBorderColorsKey, ThemeColorProp | ThemeColorPropWithAlpha> &
...
export type ZIndex = 'regular' | 'behind' | 'average' | 'high' | 'higher' | 'highest';
